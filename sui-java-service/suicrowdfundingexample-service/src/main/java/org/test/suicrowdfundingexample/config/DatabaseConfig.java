...
import org.test.suicrowdfundingexample.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.suicrowdfundingexample.*"); //add annotation mappings
