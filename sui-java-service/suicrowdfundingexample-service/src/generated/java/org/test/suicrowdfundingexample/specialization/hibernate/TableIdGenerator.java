package org.test.suicrowdfundingexample.specialization.hibernate;
...
public class TableIdGenerator<TCommand, TState> implements IdGenerator<Long, TCommand, TState> {
    ...
    private static final String DEFAULT_ROOT_ENTITY_NAME = "org.test.suicrowdfundingexample.tool.hibernate.Hello";
