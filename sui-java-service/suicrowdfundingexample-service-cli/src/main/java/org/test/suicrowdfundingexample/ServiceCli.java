...
import org.test.suicrowdfundingexample.tool.hibernate.SchemaTool;
...
public class ServiceCli {
    ...
    public static void main(final String[] args) throws Exception {
        /*
        sui-java-service % java -jar ./suiDemoContracts-service-cli/target/suidemocontracts-service-cli-0.0.1-SNAPSHOT.jar ddl -d "./suiDemoContracts-service/src/generated/resources/scripts" -c "jdbc:mysql://127.0.0.1:3306/suicrowdfundingexample_m2?enabledTLSProtocols=TLSv1.2&characterEncoding=utf8&serverTimezone=GMT%2b0&useLegacyDatetimeCode=false" -u root -p 123456
         */
        // //////////////////////////////////
