...
package org.test.suicrowdfundingexample.domain.meta;
...
public class M {
  ...
  public static class BoundedContextMetadata {
    ...
    static {
        ...
        typeToAggMap.put("Project", "Project");
        typeToAggMap.put("Donation", "Project");
        typeToAggMap.put("Platform", "Platform");
  ...
  public static class ProjectMetadata {
    ...
    private static  void initAliasMap() {
        ...
        aliasMap.put("Description", "description");
        aliasMap.put("target", "target");
        aliasMap.put("Target", "target");
        aliasMap.put("deadline", "deadline");
        aliasMap.put("Deadline", "deadline");
        aliasMap.put("image", "image");
        aliasMap.put("Image", "image");
        ...
        aliasMap.put("Deleted", "deleted");
        aliasMap.put("typeArgumentT", "typeArgumentT");
        aliasMap.put("TypeArgumentT", "typeArgumentT");
    }
  ...
  // /////////////////////////////////////////////////////////  
  public static class DonationMetadata {

    private DonationMetadata() {
    }
    ...
    public static final String[] propertyNames = new String[] {
            ...
            "deleted",
            "projectId",
            "projectDonationId.projectId",
            "projectDonationId.donator",
    };
    ...
    private static  void initAliasMap() {
        aliasMap.put("donator", "projectDonationId.donator");
        aliasMap.put("Donator", "projectDonationId.donator");
        ...
        aliasMap.put("deleted", "deleted");
        aliasMap.put("Deleted", "deleted");
        aliasMap.put("projectId", "projectDonationId.projectId");
        aliasMap.put("ProjectId", "projectDonationId.projectId");
        aliasMap.put("projectDonationId.projectId", "projectDonationId.projectId");
        aliasMap.put("ProjectDonationId.ProjectId", "projectDonationId.projectId");
        aliasMap.put("projectDonationId.donator", "projectDonationId.donator");
        aliasMap.put("ProjectDonationId.Donator", "projectDonationId.donator");
    }
